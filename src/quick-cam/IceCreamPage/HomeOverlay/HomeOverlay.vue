<template>
  <O3D>
    <O3D :layout="'ice-cream'">
      <O3D :px="-6">
        <IceCreamCone @remove="$removeClick($event)" @add="$addClick($event, () => { $router.push('/ice-cream') })" :file="require('file-loader!../IceCreamCone/model/ice-cream.glb')" :base="base" :sdk="sdk"></IceCreamCone>
      </O3D>
      <O3D>
        <IceCreamCone @remove="$removeClick($event)" @add="$addClick($event, () => { $router.push('/ice-cream') })" :file="require('file-loader!../IceCreamCone/model/ice-cream.glb')" :base="base" :sdk="sdk"></IceCreamCone>
      </O3D>
